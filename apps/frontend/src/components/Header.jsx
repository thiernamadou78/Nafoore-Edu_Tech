  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-2 bg-gold-500 text-navy font-sans font-bold text-sm px-5 py-2.5 rounded-full hover:bg-gold-400 transition-all shadow-md hover:shadow-lg hover:shadow-gold-500/20 hover:-translate-y-0.5"
        >
          Inscrire un élève
