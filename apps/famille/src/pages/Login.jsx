...
export function Login() {
  const { session, portalAccount, signIn, error } = useAuth()
    ...
    <div className="flex min-h-screen items-center justify-center bg-cream px-4">
      <Card className="w-full max-w-sm p-8">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h1 className="font-serif text-lg font-bold text-navy">Espace Famille Nafoore Education</h1>
          <p className="text-sm text-gray-500">Connecte-toi pour suivre la progression de ton enfant</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="mb-1 flex items-center justify-between">
              ...
              <Link to="/mot-de-passe-oublie" className="text-xs text-navy hover:underline">
                Mot de passe oublié ?
              </Link>
            </div>
            <PasswordInput
