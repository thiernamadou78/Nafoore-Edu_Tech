...
<html lang="fr">
  <head>
    ...
    <title>Entretien planifié — Nafoore Education</title>
  </head>
            ...
            <tr>
              <td style="padding:36px 32px 8px 32px;">
                ...
                <p style="margin:0 0 20px 0;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.6;color:#374151;">
                  ...
                  planifié le <strong>${escapeHtml(formattedDate)}</strong>. Notre équipe reviendra
                  vers vous pour vous communiquer les modalités.
                </p>
              </td>
            </tr>
            <tr>
