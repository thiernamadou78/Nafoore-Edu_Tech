            ...
            <tr>
              <td style="padding:36px 32px 8px 32px;">
                ...
                <p style="margin:0 0 20px 0;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.6;color:#374151;">
                  Nous avons bien reçu votre candidature pour rejoindre le réseau d'enseignants Nafoore Education, ainsi que vos documents. Votre dossier est en cours d'examen — nous revenons vers vous très prochainement.
                </p>
              </td>
            </tr>
            <tr>
